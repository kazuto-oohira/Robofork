...
channel_routing = [
    ...
    route("websocket.connect", vehicle_operation_status.ws_add, path="/vehicle_operation_status"),
    route("websocket.receive", vehicle_operation_status.ws_message, path="/vehicle_operation_status"),
    route("websocket.disconnect", vehicle_operation_status.ws_disconnect, path="/vehicle_operation_status"),
]
