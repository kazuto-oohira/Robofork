...
def index(request):
    return render(request, 'robofork_app/admin_setting/vehicle_type/index.html', {'users': None})


def new(request):
    return render(request, 'robofork_app/admin_setting/vehicle_type/detail.html', {'form': None})
