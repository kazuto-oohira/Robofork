...
def index(request):
    ...
    return render(request, 'robofork_app/admin_vehicle/index.html', {'vehicles': vehicles})


def new(request):
    return render(request, 'robofork_app/admin_vehicle/detail.html', {'form': VehicleForm()})
