...
export const VEHICLES_ENDPOINT = (id) => `/api/vehicle_operation_status/${id}/load`;
export const VEHICLES_UPDATE_ENDPOINT = (host, id) => `ws://${host}/vehicle_operation_status/${id}`;
